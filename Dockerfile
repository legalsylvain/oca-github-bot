...
# all html readmes.
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/legalsylvain/maintainer-tools@master-oca-gen-addons-table-add-maintainers-no-maturity#egg=oca-maintainers-tools \
